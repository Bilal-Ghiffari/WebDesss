            ...
            <div>
                ...
                <div className="absolute top-0 flex flex-wrap px-4 pt-3 md:pt-12">
                    ...
                    <div className="md:pt-8 pt-4">
                        <a className="text-white font-semibold hover:text-green-500 transition duration-200" href="https://id.wikipedia.org/wiki/Universitas_Paramadina" target="_blank" rel="noopener noreferrer">Selengkapnya</a>
                    </div>
                    </div>
                </div>
                </div>
