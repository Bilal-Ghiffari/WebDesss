...
export default function Navbar({theme, position}) {
    ...
    return (
        <Slide top>
        <header className={[position, "w-full z-40 px-5 font-display bg-blue-900"].join(" ")}>
            <div className="container mx-auto py-5">
                <div className="flex flex-stretch items-center">
                <div className="w-56 items-center flex">                   
                    <Link to="/" >
                        <img src="/images/content/logo-footer.png" alt="Logo-Navbar" />
                    </Link>
                </div>
                ...
                <div className="w-auto md:py-5">
                    <ul className={["fixed inset-0 flex flex-col items-center justify-center md:visible md:flex-row md:relative md:opacity-100 md:flex md:items-center md:mb-1 font-normal",
                        ...
                        <li className="mx-6 py-6 md:py-0">
                            <NavLink  to="/AboutUs" activeClassName="main-nav-active"  className={[theme === "white" ? "text-white md:text-white hover:underline" : "text-white md:text-black hover:underline"].join(" ")}>
                                ABOUTUS
                            </NavLink>
                        </li>
                    </ul>
